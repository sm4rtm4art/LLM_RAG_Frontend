  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        table({ children }) {
          return (
            <div className="overflow-x-auto">
              <table className="border-collapse border border-slate-300 dark:border-slate-600 w-full">{children}</table>
            </div>
          )
        },
        th({ children }) {
        ...
        td({ children }) {
          return <td className="border border-slate-300 dark:border-slate-600 p-2">{children}</td>
        },
      }}
    >
      {content}
